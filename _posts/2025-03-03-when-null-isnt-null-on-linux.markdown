...
If you like this post, please share this further! Also, if Linux and C/C++ security mitigations are of your interest, you may also want to read other content I wrote:
