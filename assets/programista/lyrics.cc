// This is a source code of Production task from Teaser Dragon CTF 2018
// Full task details can be found at:
// https://github.com/j00ru/ctf-tasks/tree/master/Dragon%20CTF%202018/Teaser/Production
//
// The program lets you read lyrics (text files) but if the opened file contains 'flag' in its name,
// it will remove it from an internal list of files.
//
// TLDR: You had to make a 2nd open call - that was used to check if a file is a symlink - fail 
// by exceeding opened files limit added with rlimit.
//
#include <dirent.h>
#include <fcntl.h>
#include <sys/stat.h>
...
namespace globals { std::vector<int> records; }  // namespace globals
...
static void welcome() { printf("Welcome to the Lyrics Explorer!\n"); }
